# Bizzy Loans - Personal Loan Application Platform
...
This project is created **solely for portfolio and educational demonstration purposes**.  
...
- UK Postcode lookup with address autofill
- Full integration with **PingYo REST API** (submission + real-time status polling)
...
Made with dedication by **Roi Emerson Lo**
